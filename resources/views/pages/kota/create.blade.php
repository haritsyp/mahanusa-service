    ...
    <div class="col">
      <div class="card shadow">
        ...
        <div class="card-body py-1">
          <form action="{{ url('admin/kota') }}" method="POST" enctype="multipart/form-data">
             @csrf
              <div class="form-group row">
                <label for="staticEmail" class="col-sm-2 col-form-label">ID</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="id" placeholder="ID Kota">
                </div>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="file" class="form-control" name="preview" placeholder="Preview">
                </div>
              </div>
              <div class="form-group row">
